...
from omni_memory.domain.model_ports import IEmbedder as Embedder
...
def build_embedder(backend: str = "auto", model_name: str = "sentence-transformers/all-MiniLM-L6-v2") -> Embedder:
    """Compatibility wrapper. Prefer omni_memory.infra.embeddings.build_embedder."""
    from omni_memory.infra.embeddings.factory import build_embedder as _build_embedder
