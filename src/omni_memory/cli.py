...
from omni_memory.infra.embeddings.factory import build_embedder
...
def _local_memory(
    *,
    ...
    from omni_memory.infra.repo.persistent_vector_repo import PersistentVectorRepo
    from omni_memory.infra.repo.graph_repo import GraphRepo
    from omni_memory.infra.repo.persistent_fact_repo import PersistentFactRepo
    from omni_memory.infra.repo.decision_repo import DecisionRepo, PersistentDecisionRepo
    from omni_memory.infra.repo.experience_repo import ExperienceRepo, PersistentExperienceRepo
...
def mcp_cmd(
    ...
    from omni_memory.mcp_server import serve_stdio
